    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <x-navbar-link :active="request()->is('/')" href="/">Home</x-navbar-link>
                <x-navbar-link :active="request()->is('about')" href="/about">About</x-navbar-link>
                <x-navbar-link :active="request()->is('contact')" href="/contact">Contact</x-navbar-link>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
